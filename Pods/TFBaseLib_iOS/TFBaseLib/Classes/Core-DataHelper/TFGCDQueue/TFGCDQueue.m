...
static TFGCDQueue *mainQueue;
static TFGCDQueue *globalQueue;
static TFGCDQueue *highPriorityGlobalQueue;
static TFGCDQueue *lowPriorityGlobalQueue;
static TFGCDQueue *backgroundPriorityGlobalQueue;

@interface TFGCDQueue ()

@property (strong, readwrite, nonatomic) dispatch_queue_t dispatchQueue;

@end

@implementation TFGCDQueue
...
+ (void)initialize
{
     ...
     */
    if (self == [TFGCDQueue self])  {
        
        mainQueue                     = [TFGCDQueue new];
        globalQueue                   = [TFGCDQueue new];
        highPriorityGlobalQueue       = [TFGCDQueue new];
        lowPriorityGlobalQueue        = [TFGCDQueue new];
        backgroundPriorityGlobalQueue = [TFGCDQueue new];
