...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "TFUILib_iOS/TFUILib/Classes/Core-View/Menu/TFNavigationDropdownMenu/TFNavigationDropdownMenu.bundle"
  install_resource "TFUILib_iOS/TFUILib/Classes/Core-View/TFNotificationView/TFNotificationView.bundle"
