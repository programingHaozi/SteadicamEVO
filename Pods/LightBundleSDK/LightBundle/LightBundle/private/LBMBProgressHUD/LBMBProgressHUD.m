...
@implementation LBMBProgressHUD
...
{
	LBMBProgressHUD *hud = [[self alloc] initWithView:view];
...
{
	LBMBProgressHUD *hud = [self HUDForView:view];
	if (hud != nil) {
		hud.removeFromSuperViewOnHide = YES;
		[hud hide:animated];
		return YES;
...
{
	NSArray *huds = [LBMBProgressHUD allHUDsForView:view];
	for (LBMBProgressHUD *hud in huds)
    {
		hud.removeFromSuperViewOnHide = YES;
		[hud hide:animated];
	}
...
+ (MB_INSTANCETYPE)HUDForView:(UIView *)view
{
	...
	for (UIView *subview in subviewsEnum)
    {
        ...
        {
			return (LBMBProgressHUD *)subview;
		}
	}
	return nil;
}
