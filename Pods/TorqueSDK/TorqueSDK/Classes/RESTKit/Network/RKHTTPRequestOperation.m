...
@interface AFURLConnectionOperation10 () <NSURLConnectionDataDelegate>
...
{
    if ([AFHTTPRequestOperation10 instancesRespondToSelector:@selector(connection:willSendRequest:redirectResponse:)]) {
