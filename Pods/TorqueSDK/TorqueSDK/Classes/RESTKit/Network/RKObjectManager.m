...
static NSString *RKMIMETypeFromAFHTTPClientParameterEncoding(AFHTTPClientParameterEncoding10 encoding)
{
    switch (encoding) {
...
NSString *RKStringFromNetworkReachabilityStatus(AFNetworkReachabilityStatus10 networkReachabilityStatus)
{
    switch (networkReachabilityStatus) {
        case AFNetworkReachabilityStatusNotReachable10:     return @"Not Reachable";
        case AFNetworkReachabilityStatusReachableViaWiFi10: return @"Reachable via WiFi";
        case AFNetworkReachabilityStatusReachableViaWWAN10: return @"Reachable via WWAN";
        case AFNetworkReachabilityStatusUnknown10:          return @"Reachability Unknown";
        default:                                          break;
    }
    return nil;
}
