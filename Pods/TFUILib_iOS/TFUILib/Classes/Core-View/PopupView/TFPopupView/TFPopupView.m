...
@property (nonatomic, assign, readwrite) TFPopupViewPosition popoverPosition;
...
- (void)commonInit
{
    ...
    self.sideEdge = 10.0;
    self.maskType = TFPopupViewrMaskTypeBlack;
             ...
             inView:(UIView *)containerView
{
    ...
    {
        case TFPopupViewrMaskTypeBlack:
            maskColor = [UIColor colorWithWhite:0.0 alpha:0.3];
            break;
        case TFPopupViewMaskTypeNone:
        {
            ...
            inView:(UIView *)containerView
{
    ...
    TFPopupViewPosition popoverPosition;
    if (upCanContain)
    {
        popoverPosition = TFPopupViewPositionUp;
        atPoint.y = CGRectGetMinY(atViewFrame) - betweenArrowAndAtView;
    }
    else
    {
        popoverPosition = TFPopupViewPositionDown;
    ...
    if (upCanContain && downCanContain)
    {
        ...
        if (position != 0)
        {
            useUp = position == TFPopupViewPositionUp ? YES : NO;
        }
        if (useUp)
        {
            popoverPosition = TFPopupViewPositionUp;
...
- (void)show
{
    ...
    CGFloat originY = 0.0;
    if (self.popoverPosition == TFPopupViewPositionDown)
    {
